...
import 'package:fitness_flutter/screens/settings/bloc/settings_bloc.dart';
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                TextButton(
                    onPressed: () => launch('https://www.facebook.com/luongdthong28899/'),
                ...
                TextButton(
                    onPressed: () => launch('https://www.instagram.com/luong.dthong.2889'),
                    style: TextButton.styleFrom(shape: CircleBorder(), backgroundColor: Colors.white, elevation: 1),
